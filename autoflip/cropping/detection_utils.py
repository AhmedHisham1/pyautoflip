...
class DetectionProcessor:
    ...
    def __init__(
        self,
        object_weights: Dict[str, float] = None
    ):
        """
        ...
        logger.debug(f"Initialized DetectionProcessor with weights: {self.object_weights}")
    ...
    def process_detections(
        ...
        for frame_idx in frame_indices:
            ...
            for obj in object_detections.get(frame_idx, []):
                ...
                # Calculate priority
                priority = self.object_weights.get(detection_class, self.object_weights.get('default', 1.0))
        ...
        for frame_idx, detections in processed_detections.items():
            ...
            for detection in detections:
                ...
                if detection.get('class', '').lower() == 'face':
                    boosted_detection['priority'] = detection.get('priority', 3.0) * boost_factor
